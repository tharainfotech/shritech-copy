...
, function(e, I, P) {
    ...
    (function(e) {
            ...
            if (Symbol.iterator in Object(e))
                return function(e, t) {
                    var n = []
                      ...
                      , a = void 0;
                    try {
                        for (var r, l = e[Symbol.iterator](); !(i = (r = l.next()).done) && (n.push(r.value),
                        !t || n.length !== t); i = !0)
                            ;
                    } catch (e) {
                        o = !0,
        ...
        function y(e) {
            ...
            b = l ? (!m && document.body && ((m = document.createElement("div")).style.cssText = "position: fixed; top: -9999px; left: 0; height: 100vh; width: 0;",
            document.body.appendChild(m)),
            (m ? m.clientHeight : 0) || a.window.innerHeight || document.documentElement.clientHeight) : a.window.innerHeight || document.documentElement.clientHeight,
            "object" !== (void 0 === e ? "undefined" : c(e)) || "load" !== e.type && "dom-loaded" !== e.type || (f = !0)
        }
        y(),
        ...
        var A = !!e.ResizeObserver && new e.ResizeObserver(function(e) {
            ...
            o.default)(function() {
                e.forEach(function(e) {
                    e.target && e.target.jarallax && (f || e.target.jarallax.onResize(),
                    g = !0)
                })
            })
        }
          ...
          , S = (t(j, [{
            key: "css",
            value: function(t, n) {
                return "string" == typeof n ? a.window.getComputedStyle(t).getPropertyValue(n) : (n.transform && d && (n[d] = n.transform),
            ...
            value: function() {
                ...
                if (!e.options.keepImg) {
                    ...
                    if (i && e.$item.setAttribute("data-jarallax-original-styles", i),
                    e.image.useImgTag) {
            ...
            value: function() {
                var e = this
                  ...
                  , r = n
                  , l = 0;
                return o && (i < 0 ? (a = i * Math.max(n, b),
                b < n && (a -= i * (n - b))) : a = i * (n + b),
                1 < i ? r = Math.abs(a - b) : i < 0 ? r = a / i + Math.abs(a) : r += (b - n) * (1 - i),
                a /= 2),
            ...
            value: function(e) {
                ...
                t.isElementInViewport = 0 <= r.bottom && 0 <= r.right && r.top <= b && r.left <= v,
                e || t.isElementInViewport) {
                    var l = Math.max(0, i)
                      ...
                      , p = 1 - 2 * (b - i) / (b + o)
                      , f = 1;
                    if (o < b ? f = 1 - (c || u) / o : s <= b ? f = s / b : d <= b && (f = d / b),
        ...
        function E(e, t) {
            ...
            for (var n = t, i = Array.prototype.slice.call(arguments, 2), o = e.length, a = 0, r = void 0; a < o; a++)
                if ("object" === (void 0 === n ? "undefined" : c(n)) || void 0 === n ? e[a].jarallax || (e[a].jarallax = new S(e[a],n)) : e[a].jarallax && (r = e[a].jarallax[n].apply(e[a].jarallax, i)),
                void 0 !== r)
                    return r;
            return e
        }
